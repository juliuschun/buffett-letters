# Warren Buffett's Letter to Shareholders — 1996

Source: Berkshire Hathaway Annual Report 1996
...
**Chairman's Letter**
    ...
    **To the Shareholders of Berkshire Hathaway Inc.:**
    ...
    _* Each Class B share has an economic interest equal to 1/30th of 
       ...
       outstanding and 1/30th of the Class B shares outstanding._
    ...
    of the 51% of GEICO we owned at year-end 1995 _increased_ significantly 
    ...
    required us to _write down_ the value of our 51% at the time we moved to 
    ...
    use of Berkshire's corporate jet,_The Indefensible_.  But Charlie has 
    ...
    **Super-Cat Insurance**
    ...
    measure. _What you must understand, however, is that a truly terrible year 
    in the super-cat business is not a possibility - it's a certainty.  The 
    only question is when it will come._
    ...
    believe that to have _then_ been the largest single catastrophe risk ever 
    ...
    **Insurance - GEICO and Other Primary Operations**
    ...
    to the company's profit-sharing plan. _Everyone_ at GEICO knows what counts.
    ...
    **Taxes**
    ...
    Security or what have you - from _any_ other American.  Berkshire 
    ...
    **Sources of Reported Earnings**
    ...
    _(in millions)                       
                                             --------------------------------------
    				                              ...
    				                              of Net Earnings  
    				                             (after taxes and  
    		                         Pre-tax Earnings   minority interests)_                                         ----------------   -------------------
    ...
    Total Earnings - All Entities...........$3,705.9  $1,008.8  $2,488.6   $ 725.2 		
                                             =======  ========  ========   =======
    _(1) Before the GEICO-related restatement.	(3) Includes Helzberg's from
                                                          April 30, 1995.
    (2) Includes R.C. Willey from June 29, 1995.	(4) Excludes interest expense
                                                          of Finance Businesses._
    ...
    **Common Stock Investments**
    ...
    _* Represents tax-basis cost which, in aggregate, is $1.2 billion 
              less than GAAP cost._
    ...
    _you_ are behind in your reading!).  At that time Coke, though it was 
    ...
    *** * * * * * * * * * * ***
    ...
    _To participate in future programs, you must own Class A shares that 
    ...
    it promptly so that it does not get put aside or forgotten._
    ...
    **The Annual Meeting**
    ...
    commercial, we will also have an abundant array of Berkshire products _for 
    sale_ in the halls outside the meeting room.  Last year we broke all 
    ...
    _(but not earlier)_ by calling 402-551-3733.  I will be at Gorat's on 
